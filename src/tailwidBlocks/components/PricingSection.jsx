...
const PricingSection = () => {
  return (
    <section>
        <section className="text-gray-600 body-font overflow-hidden darkmode">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2  col">Pricing</h1>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <h1 className="text-5xl col pb-4 mb-4 border-b border-gray-200 leading-none">Free</h1>
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
          ...
          <h1 className="text-5xl col leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span>$38</span>
