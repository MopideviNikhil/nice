...
const FeatureSection = () => {
  return (
    <section>
        <section className="text-gray-600 body-font darkmode ">
  <div className="container px-5 py-24 mx-auto dark:text-black">
    <div className="text-center mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium text-center title-font col mb-4">Raw Denim Heirloom Man Braid</h1>
